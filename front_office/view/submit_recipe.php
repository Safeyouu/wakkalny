				...
				<section class="content full-width">
					...
					<div class="submit_recipe container">
							...
							<section>
								...
								<div class="f-row">
									<div class="full"><input type="text"   placeholder="Recipe title" id="titre" name="titre" /></div>
								</div>
								<div class="f-row">
									<div class="third"><input type="text" placeholder="Preparation time"  name="prept" id="prept" /></div>
									<div class="third"><input type="text"  placeholder="Cooking time" id="cookingt" name="cookingt" /></div>
									<div class="third"><input type="text"  placeholder="Difficulty" id="difficulty"  name="difficulty"/></div>
								</div>
								<div class="f-row">
									<div class="third"><input type="text"  placeholder="Serves how many people?" id="nb_ppl" name="nb_ppl" /></div>
									<div class="third"><input type="text"  placeholder="category" id="category" name="category" /></div>
							...
							<section>
								<h2>Description</h2>
								<div class="f-row">
									<div class="full"><textarea  placeholder="Recipe title"  id="description" name="description" ></textarea></div>
								</div>
							</section>	
